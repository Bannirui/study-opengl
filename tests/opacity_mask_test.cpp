...
public:
    void OnInit() override
    {
        ...
        auto material1 = std::make_unique<OpacityMaskMaterial>();
        auto texture1  = std::make_shared<Texture>("asset/texture/grass.jpg", 0);
        material1->set_diffuse(texture1);
        auto texture2 = std::make_shared<Texture>("asset/texture/grass_mask.png", 1);
        material1->set_opacityMask(texture2);
        material1->set_enableBlend(true);
