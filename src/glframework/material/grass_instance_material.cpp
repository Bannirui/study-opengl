...
GrassInstanceMaterial::GrassInstanceMaterial() : Material("asset/shader/grass_instance.glsl") {}

void GrassInstanceMaterial::ApplyUniforms(Shader& shader, Mesh& mesh, const Camera& camera,
